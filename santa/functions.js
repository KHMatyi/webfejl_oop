...
function createRow(companion){
   ...
   // TODO 7
    const cell1 = createCell(tableRow);
    const cell2 = createCell(tableRow);
    cell1.innerHTML = companion.getName();
    cell2.innerHTML = companion.részleg; 
...
function refreshProductList(companion){ //TODO
    ...
    productTableBody.innerHTML = companion.produckts;
}
...
function addProductForm(form, factory){ // TODO
    ...
    factory.manólist[companionId].addProduct(product);
